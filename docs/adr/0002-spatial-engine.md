...
Original Linux/Windows x64 checks are historical; current required CI is Linux.
Hash equality and transformed fairness are distinct; checkpoints cannot resume battles.
...
| Metric                            | Requirement                                                            |
| --------------------------------- | ---------------------------------------------------------------------- |
| Prototype warm                    | median≤2s,p95≤4s                                                       |
| Integrated warm including storage | median≤4s,p95≤8s                                                       |
| Fresh batch                       | 1,000 matches,≤4 Workers,≤30min,≥0.56/s                                |
| Workers                           | compare1/4,reserve≥1 CPU for API/storage,default1,max4                 |
| Memory                            | Worker heap≤128MiB,whole-process RSS≤1.5GiB                            |
| Sustained                         | second-half RSS growth≤64MiB after warmup; separate heap/WASM/external |
| Storage                           | compressed≤16MiB/match,≤16GiB/1,000                                    |
| Operational                       | queue128,retained16GiB,30s real timeout=attempt failure                |
